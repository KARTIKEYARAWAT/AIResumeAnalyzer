...
files_to_update = [
    'd:/AIAnalyser/AI-Resume-Analyzer/app/routes/resume.tsx',
    'd:/AIAnalyser/AI-Resume-Analyzer/app/components/Gamification/CompleteReport.tsx'
]
...
replacements = {
    ...
    'bg-cyber-green/10': 'bg-[#a3e635]',
    'text-cyber-green': 'text-on-background',
    'border-cyber-green/30': 'border-[#1b1b1c]',
